...
Keep Cloud accounts, global workspaces, installations, bindings, catalog
projections, opaque routes, connector credentials, and relay frames distinct
from local C6 peers, roles, projects, sessions, and source truth.
